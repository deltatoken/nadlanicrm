...
class LastViewed extends \Nadlani\Core\Controllers\Base
{
    public function getActionIndex($params, $data, $request)
    {
        ...
        $maxSizeLimit = $this->getConfig()->get('recordListMaxSizeLimit', \Nadlani\Core\Controllers\Record::MAX_SIZE_LIMIT);
