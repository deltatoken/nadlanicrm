...
class Settings extends \Nadlani\Core\Controllers\Base
{
    ...
    public function postActionTestLdapConnection($params, $data)
    {
        ...
        $ldapUtils = new \Nadlani\Core\Utils\Authentication\LDAP\Utils();
        $options = $ldapUtils->normalizeOptions($data);

        $ldapClient = new \Nadlani\Core\Utils\Authentication\LDAP\Client($options);
