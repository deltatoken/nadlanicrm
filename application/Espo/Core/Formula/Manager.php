...
class Manager
{
    public function __construct(\Nadlani\Core\Container $container, \Nadlani\Core\Utils\Metadata $metadata)
    {
        $functionClassNameMap = $metadata->get(['app', 'formula', 'functionClassNameMap'], array());

        $this->evaluator = new \Nadlani\Core\Formula\Evaluator($container, $functionClassNameMap);
    }
