...
class HookManager
{
    ...
    protected $paths = [
        'corePath' => 'application/Nadlani/Hooks',
        'modulePath' => 'application/Nadlani/Modules/{*}/Hooks',
        'customPath' => 'custom/Nadlani/Custom/Hooks',
    ];
     ...
     *
     * @param array $hookDirs - it can be an array('Nadlani/Hooks', 'Nadlani/Custom/Hooks', 'Nadlani/Modules/Crm/Hooks')
     *
     * @return array
     */
