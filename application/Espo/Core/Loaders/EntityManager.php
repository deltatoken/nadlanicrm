...
namespace Nadlani\Core\Loaders;
...
class EntityManager extends Base
{
    public function load()
    {
        ...
        $params = array(
            ...
            'repositoryFactoryClassName' => '\\Nadlani\\Core\\ORM\\RepositoryFactory',
        ...
        $entityManager = new \Nadlani\Core\ORM\EntityManager($params);
        $entityManager->setNadlaniMetadata($this->getContainer()->get('metadata'));
