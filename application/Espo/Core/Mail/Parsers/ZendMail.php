...
namespace Nadlani\Core\Mail\Parsers;
...
class ZendMail
{
    ...
    public function fetchContentParts(\Nadlani\Entities\Email $email, $message, &$inlineAttachmentList = [])
    {
        $zendMessage = $message->getZendMessage();
    ...
    protected function importPartDataToEmail(\Nadlani\Entities\Email $email, $part, &$inlineIds = array(), $defaultContentType = null, &$inlineAttachmentList = [])
    {
        try {
            $type = null;
