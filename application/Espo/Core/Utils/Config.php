...
class Config
{
    private $defaultConfigPath = 'application/Nadlani/Core/defaults/config.php';

    private $systemConfigPath = 'application/Nadlani/Core/defaults/systemConfig.php';
    ...
    public function __construct(\Nadlani\Core\Utils\File\Manager $fileManager)
    {
