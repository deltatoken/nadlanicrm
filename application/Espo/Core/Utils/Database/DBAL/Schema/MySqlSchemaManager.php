...
namespace Nadlani\Core\Utils\Database\DBAL\Schema;
...
{
    /* Nadlani: default value for MariaDB 10.2.7+ */
    ...
    protected function _getPortableTableColumnDefinition($tableColumn)
    {
        ...
        switch ($dbType) {
            ...
            /* Nadlani: fix a problem of changing text field type */
            case 'tinytext':
            case 'text':
            case 'mediumtext':
            case 'longtext':
        ...
        $options = array(
            ...
            'fixed'         => (bool) $fixed,
            'default'       => /* Nadlani: default value for MariaDB 10.2.7+ */ $columnDefault /* Nadlani: end */,
