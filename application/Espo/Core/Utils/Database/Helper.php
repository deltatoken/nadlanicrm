...
class Helper
{
    ...
    protected $drivers = array(
        'mysqli' => '\Nadlani\Core\Utils\Database\DBAL\Driver\Mysqli\Driver',
        'pdo_mysql' => '\Nadlani\Core\Utils\Database\DBAL\Driver\PDOMySql\Driver',
    );

    public function __construct(\Nadlani\Core\Utils\Config $config = null)
    {
        $this->config = $config;
    }
