...
class RelationManager
{
    ...
    public function __construct(\Nadlani\Core\Utils\Metadata $metadata)
    {
    ...
    protected function getRelationClass($relationName)
    {
        ...
        $className = '\Nadlani\Custom\Core\Utils\Database\Orm\Relations\\'.$relationName;
        if (!class_exists($className)) {
            $className = '\Nadlani\Core\Utils\Database\Orm\Relations\\'.$relationName;
        }
