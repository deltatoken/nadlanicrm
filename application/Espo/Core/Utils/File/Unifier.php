...
namespace Nadlani\Core\Utils\File;

use Nadlani\Core\Utils;
...
class Unifier
{
    ...
    protected $pathToDefaults = 'application/Nadlani/Core/defaults';

    public function __construct(\Nadlani\Core\Utils\File\Manager $fileManager, \Nadlani\Core\Utils\Metadata $metadata = null, $useObjects = false)
    {
