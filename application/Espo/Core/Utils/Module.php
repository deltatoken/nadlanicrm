...
class Module
{
    ...
    protected $paths = array(
        'corePath' => 'application/Nadlani/Resources/module.json',
        'modulePath' => 'application/Nadlani/Modules/{*}/Resources/module.json',
        'customPath' => 'custom/Nadlani/Custom/Resources/module.json',
    );
    ...
    public function __construct(File\Manager $fileManager, $useCache = false)
    {
        ...
        $this->unifier = new \Nadlani\Core\Utils\File\FileUnifier($this->fileManager);
    ...
    protected function init()
    {
        if (file_exists($this->cacheFile) && $this->useCache) {
            ...
            if ($this->useCache) {
                ...
                if ($result == false) {
                    throw new \Nadlani\Core\Exceptions\Error('Module - Cannot save unified modules.');
                }
            }
        }
    }
