...
namespace Nadlani\Modules\Crm\Business\Event;
...
class Invitations
{
    ...
    public function sendInvitation(Entity $entity, Entity $invitee, $link)
    {
        ...
        $htmlizer = new \Nadlani\Core\Htmlizer\Htmlizer($this->fileManager, $dateTime, $this->number, null);
    ...
    protected function getIscContents(Entity $entity)
    {
        ...
        $ics = new Ics('//NadlaniCrm//NadlaniCrm Calendar//EN', [
