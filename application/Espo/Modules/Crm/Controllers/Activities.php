...
namespace Nadlani\Modules\Crm\Controllers;

use \Nadlani\Core\Exceptions\Error,
    \Nadlani\Core\Exceptions\Forbidden,
    \Nadlani\Core\Exceptions\BadRequest;

class Activities extends \Nadlani\Core\Controllers\Base
{
    ...
    public function getActionEntityTypeList($params, $data, $request)
    {
        ...
        \Nadlani\Core\Utils\ControllerUtil::fetchListParamsFromRequest($params, $request, $data);
