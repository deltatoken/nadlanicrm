...
namespace Nadlani\ORM\DB;

use Nadlani\ORM\Entity;
use Nadlani\ORM\IEntity;
...
abstract class Mapper implements IMapper
{
    ...
    protected $collectionClass = "\\Nadlani\\ORM\\EntityCollection";

    public function __construct(PDO $pdo, \Nadlani\ORM\EntityFactory $entityFactory, Query\Base $query) {
        $this->pdo = $pdo;
        $this->query = $query;
