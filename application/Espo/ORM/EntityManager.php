...
class EntityManager
{
    ...
    public function __construct($params)
    {
        ...
        $entityFactoryClassName = '\\Nadlani\\ORM\\EntityFactory';
        ...
        $repositoryFactoryClassName = '\\Nadlani\\ORM\\RepositoryFactory';
    ...
    public function getQuery()
    {
        if (empty($this->query)) {
            ...
            $className = '\\Nadlani\\ORM\\DB\\Query\\' . ucfirst($platform);
    ...
    protected function getMapperClassName($name)
    {
        ...
        switch ($name) {
            case 'RDB':
                $platform = $this->params['platform'];
                $className = '\\Nadlani\\ORM\\DB\\' . ucfirst($platform) . 'Mapper';
                break;
        }
