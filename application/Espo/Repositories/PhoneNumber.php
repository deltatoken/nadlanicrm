...
namespace Nadlani\Repositories;

use Nadlani\ORM\Entity;

class PhoneNumber extends \Nadlani\Core\ORM\Repositories\RDB
{
        ...
        if (!empty($phoneNumberValue)) {
            if ($phoneNumberValue !== $entity->getFetched('phoneNumber')) {
                ...
                if (!$phoneNumberNew) {
                    ...
                    $defaultType = $this->getEntityManager()->getNadlaniMetadata()->get('entityDefs.' .  $entity->getEntityType() . '.fields.phoneNumber.defaultType');
