...
class App extends \Nadlani\Core\Services\Base
{
    ...
    public function getUserData()
    {
        ...
        $language = \Nadlani\Core\Utils\Language::detectLanguage($this->getConfig(), $this->getPreferences());
    ...
    public function jobPopulateArrayValues()
    {
        ...
        foreach ($scopeList as $scope) {
            ...
            foreach ($seed->getAttributes() as $attribute => $defs) {
                if (!isset($defs['type']) || $defs['type'] !== \Nadlani\ORM\Entity::JSON_ARRAY) continue;
