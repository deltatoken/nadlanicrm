...
class MysqlCharacter extends \Nadlani\Core\Services\Base
{
    ...
    public function jobConvertToMb4()
    {
        ...
        foreach ($ormMeta as $entityName => $entityParams) {
            ...
            $tableName = \Nadlani\Core\Utils\Util::toUnderScore($entityName);
            ...
            foreach ($entityParams['fields'] as $fieldName => $fieldParams) {
                ...
                $columnName = \Nadlani\Core\Utils\Util::toUnderScore($fieldName);
