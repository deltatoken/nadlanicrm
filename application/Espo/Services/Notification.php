...
class Notification extends \Nadlani\Services\Record
{
    ...
    public function notifyAboutNote(array $userIdList, \Nadlani\Entities\Note $note)
    {
        ...
        foreach ($userList as $user) {
            ...
            $id = \Nadlani\Core\Utils\Util::generateId();
    ...
    public function checkUserNoteAccess(\Nadlani\Entities\User $user, \Nadlani\Entities\Note $note)
    {
        if ($user->isPortal()) {
