...
use \Nadlani\Core\Htmlizer\Htmlizer;

class Pdf extends \Nadlani\Core\Services\Base
{
    ...
    protected function printEntity(Entity $entity, Entity $template, Htmlizer $htmlizer, \Nadlani\Core\Pdf\Tcpdf $pdf)
    {
    ...
    public function generateMailMerge($entityType, $entityList, Entity $template, $name, $campaignId = null)
    {
        ...
        $pdf = new \Nadlani\Core\Pdf\Tcpdf();
        ...
        $filename = \Nadlani\Core\Utils\Util::sanitizeFileName($name) . '.pdf';
    ...
    public function massGenerate($entityType, $idList, $templateId, $checkAcl = false)
    {
        ...
        $filename = \Nadlani\Core\Utils\Util::sanitizeFileName($entityTypeTranslated) . '.pdf';
    ...
    public function buildFromTemplate(Entity $entity, Entity $template, $displayInline = false)
    {
        ...
        if ($displayInline) {
            ...
            $name = \Nadlani\Core\Utils\Util::sanitizeFileName($name);
            $fileName = $name . '.pdf';
