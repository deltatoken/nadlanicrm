...
class Stream extends \Nadlani\Core\Services\Base
{
    ...
    protected function getOnlyTeamEntityTypeList(\Nadlani\Entities\User $user)
    {
    ...
    protected function getOnlyOwnEntityTypeList(\Nadlani\Entities\User $user)
    {
        if ($user->isPortal()) return [];
    ...
    protected function getNotAllEntityTypeList(\Nadlani\Entities\User $user)
    {
        if (!$user->isPortal()) return [];
    ...
    protected function getIgnoreScopeList(\Nadlani\Entities\User $user)
    {
        $ignoreScopeList = [];
        $scopes = $this->getMetadata()->get('scopes', []);
        foreach ($scopes as $scope => $item) {
