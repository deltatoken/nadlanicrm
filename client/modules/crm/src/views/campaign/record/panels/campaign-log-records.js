...
Nadlani.define('crm:views/campaign/record/panels/campaign-log-records', 'views/record/panels/relationship', function (Dep) {
    ...
    return Dep.extend({
        ...
        actionCreateTargetList: function () {
            ...
            if (!this.collection.data.primaryFilter) {
                ...
                var status = Nadlani.Utils.upperCaseFirst(this.collection.data.primaryFilter).replace(/([A-Z])/g, ' $1');
