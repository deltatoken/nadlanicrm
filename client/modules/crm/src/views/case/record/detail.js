...
Nadlani.define('crm:views/case/record/detail', 'views/record/detail', function (Dep) {
    ...
    return Dep.extend({
        ...
        actionClose: function () {
            this.model.save({
                ...
                patch: true,
                success: function () {
                    Nadlani.Ui.success(this.translate('Closed', 'labels', 'Case'));
        ...
        actionReject: function () {
            this.model.save({
                ...
                patch: true,
                success: function () {
                    Nadlani.Ui.success(this.translate('Rejected', 'labels', 'Case'));
                    this.removeButton('close');
                    this.removeButton('reject');
                }.bind(this),
            });
