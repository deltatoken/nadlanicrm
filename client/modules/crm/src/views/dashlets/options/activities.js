...
Nadlani.define('crm:views/dashlets/options/activities', 'views/dashlets/options/base', function (Dep) {
    ...
    return Dep.extend({
        ...
        init: function () {
            ...
            var entityTypeList = [];
            var activitiesEntityList = Nadlani.Utils.clone(this.getConfig().get('activitiesEntityList') || []);
