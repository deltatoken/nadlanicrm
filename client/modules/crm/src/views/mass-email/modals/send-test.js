...
Nadlani.define('crm:views/mass-email/modals/send-test', ['views/modal', 'model'], function (Dep, Model) {
    ...
    return Dep.extend({
        ...
        actionSendTest: function () {
            ...
            $.ajax({
                ...
                Nadlani.Ui.success(this.translate('testSent', 'messages', 'MassEmail'));
                this.close();
            }.bind(this));
        }
