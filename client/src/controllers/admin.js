...
Nadlani.define('controllers/admin', ['controller', 'search-manager'], function (Dep, SearchManager) {
    ...
    return Dep.extend({
        ...
        rebuild: function (options) {
            ...
            Nadlani.Ui.notify(master.translate('Please wait...'));
