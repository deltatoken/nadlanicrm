...
Nadlani.define('controllers/record', 'controller', function (Dep) {
    ...
    return Dep.extend({
        ...
        getViewName: function (type) {
            return this.viewMap[type] || this.getMetadata().get(['clientDefs', this.name, 'views', type]) || 'views/' + Nadlani.Utils.camelCaseToHyphen(type);
        },
