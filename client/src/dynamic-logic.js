...
Nadlani.define('dynamic-logic', [], function () {
    ...
    _.extend(DynamicLogic.prototype, {
        ...
        process: function () {
            ...
            Object.keys(fields).forEach(function (field) {
                ...
                this.fieldTypeList.forEach(function (type) {
                    ...
                    var methodName;
                    if (result) {
                        methodName = 'makeField' + Nadlani.Utils.upperCaseFirst(type) + 'True';
                    } else {
                        methodName = 'makeField' + Nadlani.Utils.upperCaseFirst(type) + 'False';
                    }
        ...
        processPanel: function (panel, type) {
            ...
            var methodName;
            if (result) {
                methodName = 'makePanel' + Nadlani.Utils.upperCaseFirst(type) + 'True';
            } else {
                methodName = 'makePanel' + Nadlani.Utils.upperCaseFirst(type) + 'False';
            }
