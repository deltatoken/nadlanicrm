...
Nadlani.define('email-helper', [], function () {
    ...
    _.extend(EmailHelper.prototype, {
        ...
        getReplyAttributes: function (model, data, cc) {
            ...
            if (model.get('teamsIds') && model.get('teamsIds').length) {
                attributes.teamsIds = Nadlani.Utils.clone(model.get('teamsIds'));
                attributes.teamsNames = Nadlani.Utils.clone(model.get('teamsNames') || {});
