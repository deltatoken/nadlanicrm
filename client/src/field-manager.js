 ...
 ************************************************************************/
 ...
 Nadlani.define('field-manager', [], function () {
    ...
    _.extend(FieldManager.prototype, {
                ...
                if ('actualFields' in this.defs[fieldType]) {
                    ...
                    if (naming == 'prefix') {
                        actualfFields.forEach(function (f) {
                            fieldNames.push(f + Nadlani.Utils.upperCaseFirst(fieldName));
                        });
                    } else {
                        actualfFields.forEach(function (f) {
                            fieldNames.push(fieldName + Nadlani.Utils.upperCaseFirst(f));
                        });
                    }
                } else {
        ...
        getViewName: function (fieldType) {
            ...
            return 'views/fields/' + Nadlani.Utils.camelCaseToHyphen(fieldType);
        },
