...
Nadlani.define('ui', [], function () {
    ...
    var Ui = Nadlani.Ui = Nadlani.ui = {
        ...
        warning: function (message) {
            Nadlani.Ui.notify(message, 'warning', 2000);
        },

        success: function (message) {
            Nadlani.Ui.notify(message, 'success', 2000);
        },

        error: function (message) {
            Nadlani.Ui.notify(message, 'error', 2000);
        },

        info: function (message) {
            Nadlani.Ui.notify(message, 'info', 2000);
        },
    }
