...
Nadlani.define('views/admin/authentication/fields/test-connection', 'views/fields/base', function (Dep) {
    ...
    return Dep.extend({
        ...
        testConnection: function () {
            ...
            $.ajax({
                ...
                this.$el.find('button').prop('disabled', false);
                Nadlani.Ui.success(this.translate('ldapTestConnection', 'messages', 'Settings'));
            }.bind(this));
