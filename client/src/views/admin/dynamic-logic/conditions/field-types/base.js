...
Nadlani.define('views/admin/dynamic-logic/conditions/field-types/base', 'view', function (Dep) {
    ...
    return Dep.extend({
        ...
        manageValue: function () {
            ...
            if (valueType === 'field') {
                ...
                var methodName = 'createValueView' + Nadlani.Utils.upperCaseFirst(this.type);
                this[methodName]();
            } else {
                this.clearView('value');
            }
