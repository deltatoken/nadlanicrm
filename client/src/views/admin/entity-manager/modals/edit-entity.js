...
Nadlani.define('views/admin/entity-manager/modals/edit-entity', ['views/modal', 'model'], function (Dep, Model) {
        ...
        actionSave: function () {
            ...
            $.ajax({
                ...
                if (this.scope) {
                    ...
                    Nadlani.Ui.success(this.translate('entityCreated', 'messages', 'EntityManager'));
                }
