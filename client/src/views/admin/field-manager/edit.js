...
Nadlani.define('views/admin/field-manager/edit', ['view', 'model'], function (Dep, Model) {
        ...
        setupFieldData: function (callback) {
            ...
            this.getModelFactory().create(this.scope, function (model) {
                ...
                Promise.race([
                    ...
                    this.paramList = [];
                    var paramList = Nadlani.Utils.clone(this.getFieldManager().getParams(this.type) || []);
                    ...
                    paramList.forEach(function (o) {
                        ...
                        var disableParamName = 'customization' + Nadlani.Utils.upperCaseFirst(item) + 'Disabled';
                        if (this.getMetadata().get('entityDefs.' + this.scope + '.fields.' + this.field + '.' + disableParamName)) {
                            return;
                        }
                        var viewParamName = 'customization' + Nadlani.Utils.upperCaseFirst(item) + 'View';
