...
Nadlani.define('views/admin/field-manager/fields/dynamic-logic-conditions', 'views/fields/base', function (Dep) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            this.conditionGroup = Nadlani.Utils.cloneDeep((this.model.get(this.name) || {}).conditionGroup || []);
