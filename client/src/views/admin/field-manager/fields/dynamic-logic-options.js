...
Nadlani.define('views/admin/field-manager/fields/dynamic-logic-options', ['views/fields/base', 'model'], function (Dep, Model) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            this.optionsDefsList = Nadlani.Utils.cloneDeep(this.model.get(this.name)) || []
