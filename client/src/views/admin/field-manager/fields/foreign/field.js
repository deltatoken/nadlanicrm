...
Nadlani.define('views/admin/field-manager/fields/foreign/field', 'views/fields/enum', function (Dep) {
    ...
    return Dep.extend({
        ...
        setupOptionsByLink: function () {
            ...
            this.params.options = Object.keys(Nadlani.Utils.clone(fields)).filter(function (item) {
