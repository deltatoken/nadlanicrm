...
Nadlani.define('views/admin/field-manager/fields/foreign/link', 'views/fields/enum', function (Dep) {
    ...
    return Dep.extend({
        ...
        setupOptions: function () {
            ...
            this.params.options = Object.keys(Nadlani.Utils.clone(links)).filter(function (item) {
