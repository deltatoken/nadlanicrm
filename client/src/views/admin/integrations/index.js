...
Nadlani.define('views/admin/integrations/index', 'view', function (Dep) {
    ...
    return Dep.extend({
        ...
        openIntegration: function (integration) {
            ...
            var viewName = this.getMetadata().get('integrations.' + integration + '.view') || 'views/admin/integrations/' + Nadlani.Utils.camelCaseToHyphen(this.getMetadata().get('integrations.' + integration + '.authMethod'));
            this.notify('Loading...');
