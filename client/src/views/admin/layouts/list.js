...
Nadlani.define('views/admin/layouts/list', 'views/admin/layouts/rows', function (Dep) {
    ...
    return Dep.extend({
        ...
        loadLayout: function (callback) {
            this.getModelFactory().create(Nadlani.Utils.hyphenToUpperCamelCase(this.scope), function (model) {
        ...
        readDataFromLayout: function (model, layout) {
            ...
            for (var i in this.rowLayout) {
                ...
                this.itemsData[this.rowLayout[i].name] = Nadlani.Utils.cloneDeep(this.rowLayout[i]);
            }
        },
