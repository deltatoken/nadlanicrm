...
Nadlani.define('views/admin/layouts/relationships', 'views/admin/layouts/rows', function (Dep) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            this.dataAttributesDefs = Nadlani.Utils.cloneDeep(this.dataAttributesDefs);
