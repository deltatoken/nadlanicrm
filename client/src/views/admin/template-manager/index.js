...
Nadlani.define('views/admin/template-manager/index', 'view', function (Dep) {
        ...
        setup: function () {
            ...
            templateList.forEach(function (template) {
                ...
                if (defs.scopeListConfigParam || defs.scopeList) {
                    var scopeList = Nadlani.Utils.clone(defs.scopeList || this.getConfig().get(defs.scopeListConfigParam) || []);
