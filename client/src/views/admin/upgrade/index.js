...
Nadlani.define('views/admin/upgrade/index', 'view', function (Dep) {
    ...
    return Dep.extend({
        ...
        data: function () {
            return {
                ...
                downloadMsg: this.translate('downloadUpgradePackage', 'messages', 'Admin').replace('{url}', 'https://www.facebook.com/sites4u2/download/upgrades')
            };
        },
