...
Nadlani.define('views/dashlet', 'view', function (Dep) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            var viewName = this.getMetadata().get('dashlets.' + this.name + '.view') || 'views/dashlets/' + Nadlani.Utils.camelCaseToHyphen(this.name);
