 ...
 ************************************************************************/
Nadlani.define('views/dashlets/fields/records/bool-filter-list', 'views/fields/multi-enum', function (Dep) {
        ...
        setupOptions: function () {
            ...
            filterList.forEach(function (item) {
                    ...
                    if (item.accessDataList) {
                        if (!Nadlani.Utils.checkAccessDataList(item.accessDataList, this.getAcl(), this.getUser(), null, true)) {
                            return false;
                        }
                    }
