...
Nadlani.define('views/dashlets/options/base', ['views/modal', 'views/record/detail', 'model', 'view-record-helper'], function (Dep, Detail, Model, ViewRecordHelper) {
    ...
    return Dep.extend({
        ...
        init: function () {
            ...
            this.fields = Nadlani.Utils.cloneDeep(this.options.fields);
