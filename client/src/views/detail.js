...
Nadlani.define('views/detail', 'views/main', function (Dep) {
    ...
    return Dep.extend({
        ...
        actionSelectRelated: function (data) {
            ...
            var filters = Nadlani.Utils.cloneDeep(this.selectRelatedFilters[link]) || {};
            ...
            var boolFilterList = dataBoolFilterList || Nadlani.Utils.cloneDeep(this.selectBoolFilterLists[link] || []);
