...
Nadlani.define('views/email/record/detail', 'views/record/detail', function (Dep) {
    ...
    return Dep.extend({
        ...
        actionMoveToTrash: function () {
            $.ajax({
                ...
                Nadlani.Ui.warning(this.translate('Moved to Trash', 'labels', 'Email'));
            }.bind(this));
        ...
        actionRetrieveFromTrash: function () {
            $.ajax({
                ...
                Nadlani.Ui.warning(this.translate('Retrieved from Trash', 'labels', 'Email'));
            }.bind(this));
        ...
        send: function () {
            ...
            var afterSend = function () {
                Nadlani.Ui.success(this.translate('emailSent', 'messages', 'Email'));
            ...
            this.once('before:save', function () {
                Nadlani.Ui.notify(this.translate('Sending...', 'labels', 'Email'));
            }, this);
