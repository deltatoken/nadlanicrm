...
Nadlani.define('views/fields/attachment-multiple', 'views/fields/base', function (Dep) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            this.sourceList = Nadlani.Utils.clone(this.params.sourceList || []).filter(function (item) {
