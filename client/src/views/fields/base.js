...
Nadlani.define('views/fields/base', 'view', function (Dep) {
    ...
    return Dep.extend({
        ...
        setMode: function (mode) {
            ...
            if (!(property in this)) {
                this[property] = 'fields/' + Nadlani.Utils.camelCaseToHyphen(this.type) + '/' + this.mode;
            }
        ...
        validate: function () {
            for (var i in this.validations) {
                var method = 'validate' + Nadlani.Utils.upperCaseFirst(this.validations[i]);
