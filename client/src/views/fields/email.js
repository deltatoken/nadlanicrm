...
Nadlani.define('views/fields/email', 'views/fields/varchar', function (Dep) {
    ...
    return Dep.extend({
        ...
        data: function () {
            ...
            if (this.mode == 'edit') {
                emailAddressData = Nadlani.Utils.clone(this.model.get(this.dataFieldName));
            ...
            if (emailAddressData) {
                emailAddressData = Nadlani.Utils.cloneDeep(emailAddressData);
        ...
        events: {
            ...
            'click [data-action="addEmailAddress"]': function () {
                var data = Nadlani.Utils.cloneDeep(this.fetchEmailAddressData());
