...
Nadlani.define('views/fields/formula', 'views/fields/text', function (Dep) {
            ...
            if (this.mode == 'edit' || this.mode == 'detail') {
                ...
                Promise.all([
                    new Promise(function (resolve) {
                        Nadlani.loader.load('lib!client/lib/ace/ace.js', function () {
                            Nadlani.loader.load('lib!client/lib/ace/mode-javascript.js', function () {
                                resolve();
                            }.bind(this));
                        }.bind(this));
                    }.bind(this))
