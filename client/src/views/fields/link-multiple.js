...
Nadlani.define('views/fields/link-multiple', 'views/fields/base', function (Dep) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            if (this.mode == 'search') {
                ...
                this.nameHash = Nadlani.Utils.clone(nameHash);
                this.ids = Nadlani.Utils.clone(idList);
            } else {
                this.ids = Nadlani.Utils.clone(this.model.get(this.idsName) || []);
                this.nameHash = Nadlani.Utils.clone(this.model.get(this.nameHashName) || {});
            }
