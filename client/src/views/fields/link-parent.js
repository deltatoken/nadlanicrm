...
Nadlani.define('views/fields/link-parent', 'views/fields/base', function (Dep) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            this.foreignScopeList = Nadlani.Utils.clone(this.foreignScopeList).filter(function (item) {
