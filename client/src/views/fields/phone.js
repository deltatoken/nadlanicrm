...
Nadlani.define('views/fields/phone', 'views/fields/varchar', function (Dep) {
    ...
    return Dep.extend({
        ...
        data: function () {
            var phoneNumberData;
            if (this.mode == 'edit') {
                phoneNumberData = Nadlani.Utils.cloneDeep(this.model.get(this.dataFieldName));
            ...
            if (phoneNumberData) {
                phoneNumberData = Nadlani.Utils.cloneDeep(phoneNumberData);
        ...
        events: {
            ...
            'click [data-action="addPhoneNumber"]': function () {
                var data = Nadlani.Utils.cloneDeep(this.fetchPhoneNumberData());
