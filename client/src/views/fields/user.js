...
Nadlani.define('views/fields/user', 'views/fields/link', function (Dep) {
    ...
    return Dep.extend({
        ...
        setupSearch: function () {
            ...
            this.searchTypeList = Nadlani.Utils.clone(this.searchTypeList);
            ...
            if (this.mode == 'search') {
                ...
                $elemeneTeams.autocomplete({
                    serviceUrl: function (q) {
                        return 'Team?orderBy=name&maxSize=' + this.getAutocompleteMaxCount();
                    }.bind(this),
                    minChars: 1,
