...
Nadlani.define('views/import/step2', 'view', function (Dep) {
    ...
    return Dep.extend({
            ...
            for (var field in fields) {
                ...
                if (d.type == 'phone') {
                    (this.getMetadata().get('entityDefs.' + this.scope + '.fields.' + field + '.typeList' ) || []).map(function (item) {
                        ...
                        attributeList.push(field + Nadlani.Utils.upperCaseFirst(item));
                    }, this);
                    continue;
                }
        ...
        addField: function (name) {
            ...
            var type = Nadlani.Utils.upperCaseFirst(this.model.getFieldParam(name, 'type'));
