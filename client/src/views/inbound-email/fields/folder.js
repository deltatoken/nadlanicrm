...
Nadlani.define('views/inbound-email/fields/folder', 'views/fields/base', function (Dep) {
        ...
        events: {
            'click [data-action="selectFolder"]': function () {
                ...
                $.ajax({
                    ...
                    data: data,
                    error: function (xhr) {
                        Nadlani.Ui.error(self.translate('couldNotConnectToImap', 'messages', 'InboundEmail'));
