...
Nadlani.define('views/list', ['views/main', 'search-manager'], function (Dep, SearchManager) {
    ...
    return Dep.extend({
        ...
        setViewMode: function (mode, toStore) {
            ...
            var methodName = 'setViewMode' + Nadlani.Utils.upperCaseFirst(this.viewMode);
            if (this[methodName]) {
                this[methodName]();
                return;
            }
        ...
        getRecordViewName: function () {
            ...
            var propertyName = 'record' + Nadlani.Utils.upperCaseFirst(this.viewMode) + 'View';
        ...
        loadList: function () {
            var methodName = 'loadList' + Nadlani.Utils.upperCaseFirst(this.viewMode);
            if (this[methodName]) {
                this[methodName]();
                return;
            }
