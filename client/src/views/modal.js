...
Nadlani.define('views/modal', 'view', function (Dep) {
    ...
    return Dep.extend({
        ...
        init: function () {
            ...
            this.buttonList = Nadlani.Utils.cloneDeep(this.buttonList);

            // TODO remove it as depricated
            this.buttons = Nadlani.Utils.cloneDeep(this.buttons);
            ...
            this.on('render', function () {
                ...
                this.buttons.forEach(function (item) {
                    var o = Nadlani.Utils.clone(item);
                ...
                this.buttonList.forEach(function (item) {
                    ...
                    o.onClick = o.onClick || (this['action' + Nadlani.Utils.upperCaseFirst(o.name)] || function () {}).bind(this);
                ...
                this.dialog = new Nadlani.Ui.Dialog({
