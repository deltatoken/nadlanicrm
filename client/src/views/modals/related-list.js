...
Nadlani.define('views/modals/related-list', ['views/modal', 'search-manager'], function (Dep, SearchManager) {
    ...
    return Dep.extend({
        ...
        loadSearch: function () {
            ...
            var filterList = Nadlani.Utils.clone(this.getMetadata().get(['clientDefs', this.scope, 'filterList']) || []);
