...
Nadlani.define('views/modals/select-category-tree-records', 'views/modals/select-records', function (Dep) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            Nadlani.require('search-manager', function (SearchManager) {
