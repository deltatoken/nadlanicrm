...
Nadlani.define('views/note/fields/post', ['views/fields/text', 'lib!Textcomplete'], function (Dep, Textcomplete) {
            ...
            if (/^http(s){0,1}\:\/\//.test(text)) {
                ...
                if (regExp.test(text)) {
                    ...
                    this.ajaxPostRequest('Attachment/action/getAttachmentFromImageUrl', {
                        ...
                        var attachmentIdList = Nadlani.Utils.clone(this.model.get('attachmentsIds') || []);
                        var attachmentNames = Nadlani.Utils.clone(this.model.get('attachmentsNames') || {});
                        var attachmentTypes = Nadlani.Utils.clone(this.model.get('attachmentsTypes') || {});
