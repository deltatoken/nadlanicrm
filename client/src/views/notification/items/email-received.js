...
Nadlani.define('views/notification/items/email-received', 'views/notification/items/base', function (Dep) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            this.messageData['entityType'] = Nadlani.Utils.upperCaseFirst((this.translate(data.entityType, 'scopeNames') || '').toLowerCase());
