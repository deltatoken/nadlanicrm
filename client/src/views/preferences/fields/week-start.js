...
Nadlani.define('views/preferences/fields/week-start', 'views/fields/enum-int', function (Dep) {
    ...
    return Dep.extend({
        ...
        setupOptions: function () {
            ...
            this.translatedOptions = Nadlani.Utils.clone(this.getLanguage().translate('weekStart', 'options', 'Settings') || {});
