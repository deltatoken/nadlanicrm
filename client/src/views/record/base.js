...
Nadlani.define('views/record/base', ['view', 'view-record-helper', 'dynamic-logic'], function (Dep, ViewRecordHelper, DynamicLogic) {
    ...
    return Dep.extend({
        ...
        initDynamicLogic: function () {
            this.dynamicLogicDefs = Nadlani.Utils.clone(this.dynamicLogicDefs || {});
            this.dynamicLogicDefs.fields = Nadlani.Utils.clone(this.dynamicLogicDefs.fields);
            this.dynamicLogicDefs.panels = Nadlani.Utils.clone(this.dynamicLogicDefs.panels);
        ...
        save: function (callback, skipExit) {
            ...
            data = _.extend(Nadlani.Utils.cloneDeep(beforeSaveAttributes), data);
            ...
            model.save(attrs, {
                ...
                error: function (e, xhr) {
                    ...
                    if (response && response.reason) {
                        var methodName = 'errorHandler' + Nadlani.Utils.upperCaseFirst(response.reason.toString());
        ...
        _doDependencyAction: function (data) {
            ...
            var methodName = 'dependencyAction' + Nadlani.Utils.upperCaseFirst(action);
