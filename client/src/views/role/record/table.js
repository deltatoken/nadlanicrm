...
Nadlani.define('views/role/record/table', 'view', function (Dep) {
    ...
    return Dep.extend({
        ...
        setupData: function () {
            ...
            if (this.options.acl) {
                ...
                this.acl.data = Nadlani.Utils.cloneDeep(this.model.get('data') || {});
            }
            if (this.options.acl) {
                this.acl.fieldData = this.options.acl.fieldData;
            } else {
                this.acl.fieldData = Nadlani.Utils.cloneDeep(this.model.get('fieldData') || {});
            }
            this.setupScopeList();
