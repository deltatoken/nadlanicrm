...
Nadlani.define('views/stream/panel', ['views/record/panels/relationship', 'lib!Textcomplete'], function (Dep, Textcomplete) {
    ...
    return Dep.extend({
        ...
        post: function () {
            ...
            this.getModelFactory().create('Note', function (model) {
                ...
                model.set('attachmentsIds', Nadlani.Utils.clone(this.seed.get('attachmentsIds') || []));
                model.set('type', 'Post');
