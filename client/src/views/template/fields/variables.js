 ...
 ************************************************************************/
Nadlani.define('views/template/fields/variables', 'views/fields/base', function (Dep) {
    ...
    return Dep.extend({
        ...
        setupAttributeList: function () {
            ...
            var forbiddenList = Nadlani.Utils.clone(this.getAcl().getScopeForbiddenAttributeList(entityType));
            ...
            linkList.forEach(function (link) {
                ...
                var forbiddenList = Nadlani.Utils.clone(this.getAcl().getScopeForbiddenAttributeList(scope));
