...
Nadlani.define('views/user/record/edit', ['views/record/edit', 'views/user/record/detail'], function (Dep, Detail) {
    ...
    return Dep.extend({
        ...
        getGridLayout: function (callback) {
            this._helper.layoutManager.get(this.model.name, this.options.layoutName || this.layoutName, function (simpleLayout) {
                var layout = Nadlani.Utils.cloneDeep(simpleLayout);
        ...
        errorHandlerUserNameExists: function () {
            Nadlani.Ui.error(this.translate('userNameExists', 'messages', 'User'))
        }
