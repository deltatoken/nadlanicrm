...
class CronManagerTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->objects['scheduledJob'] = $this->getMockBuilder('\\Nadlani\\Core\\Utils\\ScheduledJob')->disableOriginalConstructor()->getMock();
        $this->objects['entityManager'] = $this->getMockBuilder('\\Nadlani\\Core\\ORM\\EntityManager')->disableOriginalConstructor()->getMock();
        ...
        $this->object = new \Nadlani\Core\CronManager( $this->objects['container'] );
