...
class QueryTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->post = new \Nadlani\Entities\Post();
        $this->comment = new \Nadlani\Entities\Comment();
        $this->tag = new \Nadlani\Entities\Tag();
        $this->note = new \Nadlani\Entities\Note();

        $this->contact = new \Nadlani\Entities\Contact();
        $this->account = new \Nadlani\Entities\Account();
    }
